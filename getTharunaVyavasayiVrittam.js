...
function getTharunaVyavasayiVrittam (){
  docRef3.doc('details').get().then(function (doc){
      if(doc && doc.exists){
          ...
          document.getElementById('smkaryakarinum').innerText += " : " + myData.karyakarinum11;
          document.getElementById('smkaryakarinum1').innerText += " : " + myData.karyakarinum111;
          ...
          document.getElementById('smgangajali').innerText += " : " + myData.gangajali111;
          document.getElementById('smgangajali1').innerText += " : " + myData.gangajali1111;
          document.getElementById('smsevanam').innerText += " : " + myData.sevanam1;
          document.getElementById('smyes').innerText += " : " + myData.yes1;
          document.getElementById('smsharirik').innerText += " : " + myData.sharirik11;
          document.getElementById('smbhawdhik').innerText += " : " + myData.bhawdhik11;
